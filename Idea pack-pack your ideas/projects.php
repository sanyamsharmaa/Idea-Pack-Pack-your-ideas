...
<head>
    ...
    <title>Idea Pack:Projects ideas</title>
    <link rel="icon" href="Logo.png">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-4bw+/aepP/YC94hEpVNVgiZdgIC5+VKNBQNGCHeKRQN+PtmoHDEXuppvnDJzQIu9" crossorigin="anonymous">
    <script src="IG.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
</head>
<body style="background-image: url('https://images.unsplash.com/photo-1544006659-f0b21884ce1d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bWFuJTIwbGFwdG9wfGVufDB8fDB8fHww&w=1000&q=80');
...
">
    <header>
        <header>
            ...
            <nav class="navbar navbar-expand-lg  bg-warning p-1 shadow-lg  mb-5 bg-body-warning " >
                    ...
                    <ul class="navbar-nav ">
                      ...
                      <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item icon-link-hover" style="-icon-link-hover-color-rgb: 25, 135, 84;" href="projects.html">Project ideas</a></li>
        ...
        <main>
          <form action="form.php" method="post">
            <div class="cntr mt-5 mx-auto w-75 shadow-lg "> 
              <div class="input-group mb-1 position-relative start-50 translate-middle w-50">
                <input type="hidden" name="adbtn" id="adbtn" value="add2">
                <input type="text" class="form-control" name="pdtn" id="pdtn" placeholder="Got new projects idea! Add ..." aria-label="Recipient's username" aria-describedby="button-addon2">
                <button type="submit" name="adbtn" class="btn btn-success">Add</button>
              </div>
            </form>
        <ul class="list-group ">
          <li class="list-group-item d-flex p-1 justify-content-between align-items-center fs-5 "><div>To bring all the items for hostel</div> 
            <div>
              <button type="button" class="btn btn-warning " onclick="edtask(this)">Edit</button> 
              <button type="button" class="btn btn-danger  ml-2" onclick="dltask(this)">Remove</button>
            </div>
            </li>
